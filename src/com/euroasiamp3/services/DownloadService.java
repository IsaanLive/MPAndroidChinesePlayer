...
import com.euroasia.cn.DownloadingActivity;
import com.euroasia.cn.R;
...
public class DownloadService extends Service {
	...
	public class DownloadFilesTask  extends AsyncTask<String, Void, Void> {
		...
		protected void onCancelled() {
			...
			regularNotif("下载已取消","取消: "+filename,filename); 
		...
		protected void onPostExecute(Void result) {
			...
			if(fail == 1){
				regularNotif("下载失败","失败: "+filename,filename); 
				http--;
				...
				regularNotif("下载完成","完成: "+filename,filename); 
			}
		...
		public void ongoingNotif(String contentTitle, String tickerText, String contentText ){
			...
			notification.setLatestEventInfo(context, contentTitle, "点击这里查看进度", contentIntent);
			notificationManager.notify(numberd+9, notification);
		}
